...
function showFinalPrice(price, isDicountAvaliable) {
    if (isDicountAvaliable) {
...
const isDicountAvaliable = price >= discountStartsFrom;
const finalPrice = isDicountAvaliable ? calculateDiscountPrice(price) : price;
showFinalPrice(finalPrice, isDicountAvaliable);